class User < ApplicationRecord
  ...
  pg_search_scope :search_by_identifier,
  ...
  def generate_phone_confirmation_code
    if self.phone_confirmation_code && !phone_confirmation_period_expired?
      ...
      self.phone_confirmation_code = @raw_phone_confirmation_code = (SecureRandom.random_number(9e5) + 1e5).to_i
  ...
  def generate_disable_2fa_confirmation_code
    if self.disable_2fa_confirmation_code && !disable_2fa_period_expired?
      ...
      self.disable_2fa_confirmation_code = @raw_disable_2fa_confirmation_code = (SecureRandom.random_number(9e5) + 1e5).to_i

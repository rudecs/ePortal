class API::V1 < Grape::API
  ...
  mount API::V1::CloudSpacesResource
  mount API::V1::DisksResource
  mount API::V1::ImagesResource
  mount API::V1::LocationsResource
  mount API::V1::MachinesResource
  mount API::V1::PingResource
  mount API::V1::PortsResource
  mount API::V1::SnapshotsResource
end

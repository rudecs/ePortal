class API::Internal::V1 < Grape::API
  ...
  mount API::Internal::V1::ProductsResource
  mount API::Internal::V1::ProductInstancesResource
  mount API::Internal::V1::ProductInstances::BulkResource
end
